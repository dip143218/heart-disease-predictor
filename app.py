...
Paste করার পর **Commit changes** click করো।

---

## Step 2: requirements.txt বানাও

আবার **Add file → Create new file**
...
## Step 3: Model files upload করো

**Add file → Upload files** click করো

Kaggle থেকে download করা এই দুটো drag করো:
```
...
সব হলে repository তে ৪টা file দেখাবে:
```
README.md
app.py
requirements.txt
